...
You can call tools for web search and charting.`,
  ...
  private shouldUseToolRouter(): boolean {
    const flag = process.env.H1DR4_TOOL_ROUTER;
    if (!flag) {
      return false;
    }
    return flag.toLowerCase() === "on" || flag.toLowerCase() === "true";
  }
