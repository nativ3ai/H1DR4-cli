...
async function createServer() {
  ...
  server.registerTool(
    ...
    {
      description:
        "Fetch market data for commodities, equities, index, RWAs, or crypto. Provide category and optional symbol.",
      inputSchema: {
        category: z
          .enum(["commodities", "equities", "index", "rwa", "crypto"])
          .describe("Asset class to query"),
        symbol: z
          .string()
          .describe("Ticker symbol (e.g., GOLD, AAPL, ^GSPC, BTCUSD)")
          .optional(),
      },
    },
